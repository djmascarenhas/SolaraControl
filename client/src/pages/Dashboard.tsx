          ...
          {overview && (
            <div className="grid grid-cols-3 gap-4">
              <div className="border rounded-lg p-4 bg-card">
                <p className="text-xs text-muted-foreground uppercase tracking-wider">{pt ? "Total Tickets" : "Total Tickets"}</p>
                <p className="text-2xl font-bold mt-1" data-testid="text-total-tickets">{overview.total_tickets}</p>
              </div>
              <div className="border rounded-lg p-4 bg-card">
                <p className="text-xs text-muted-foreground uppercase tracking-wider">{pt ? "Abertos" : "Open"}</p>
                <p className="text-2xl font-bold mt-1 text-amber-500" data-testid="text-open-tickets">{overview.open_tickets}</p>
              </div>
              <div className="border rounded-lg p-4 bg-card">
                <p className="text-xs text-muted-foreground uppercase tracking-wider">{pt ? "Concluídos" : "Done"}</p>
                <p className="text-2xl font-bold mt-1 text-emerald-500" data-testid="text-done-tickets">{overview.done_tickets}</p>
              </div>
            </div>
          )}
